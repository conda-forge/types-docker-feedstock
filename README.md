...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-docker-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-docker-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-docker
# for installing globally
pixi global install types-docker
```
...
It is possible to list all of the versions of `types-docker` available on your platform:
...
```
pixi search types-docker --channel conda-forge
```
